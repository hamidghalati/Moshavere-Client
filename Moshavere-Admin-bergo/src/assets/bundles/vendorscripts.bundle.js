...
!function(t, e) {
    ...
    var r, i, o, s, a, l, h, c, p = function(s) {
        ...
        a.supportsTransitionEnd() && (s.event.special[a.TRANSITION_END] = {
            bindType: e.end,
            delegateType: e.end,
            handle: function(t) {
    ...
    c = function() {
        ...
        return a.prototype.init = function() {
            var n = this;
            r(this._element).find(this._config.parentTrigger + "." + this._config.activeClass).has(this._config.subMenu).children(this._config.subMenu).attr("aria-expanded", !0).addClass(this._config.collapseClass + " " + this._config.collapseInClass),
            r(this._element).find(this._config.parentTrigger).not("." + this._config.activeClass).has(this._config.subMenu).children(this._config.subMenu).attr("aria-expanded", !1).addClass(this._config.collapseClass),
            r(this._element).find(this._config.parentTrigger).has(this._config.subMenu).children(this._config.triggerElement).on(h.CLICK_DATA_API, function(t) {
                var e = r(this)
                ...
                "true" !== e.attr("aria-disabled") && (i.hasClass(n._config.activeClass) ? (e.attr("aria-expanded", !1),
                n._hide(a)) : (n._show(a),
            ...
            return this.each(function() {
                function e(t) {
                    if (r) {
                        ...
                        w(t.target || t.srcTarget || t.srcElement).closest("." + _.wrapperClass).is(f.parent()) && s(e, !0),
                ...
                function s(t, e, i) {
                    ...
                    e && (e = parseInt(m.css("top")) + t * parseInt(_.wheelStep) / 100 * m.outerHeight(),
                    ...
                    i && (t = (e = t) / f[0].scrollHeight * f.outerHeight(),
                ...
                function i() {
                    p = Math.max(f.outerHeight() / f[0].scrollHeight * f.outerHeight(), 30),
                    m.css({
                        height: p + "px"
                    });
                ...
                function a() {
                    i(),
                    clearTimeout(h),
                    u == ~~u ? (g = _.allowPageScroll,
                    d != u && f.trigger("slimscroll", 0 == ~~u ? "top" : "bottom")) : g = !1,
                    d = u,
                    p >= f.outerHeight() ? g = !0 : (m.stop(!0, !0).fadeIn("fast"),
                    _.railVisible && y.stop(!0, !0).fadeIn("fast"))
                }
                function n() {
                    _.alwaysVisible || (h = setTimeout(function() {
                        _.disableFadeOut && r || o || l || (m.fadeOut("slow"),
                        y.fadeOut("slow"))
                    }, 1e3))
                }
                ...
                if (f.parent().hasClass(_.wrapperClass)) {
                    ...
                    w.isPlainObject(x)) {
                        if ("height"in x && "auto" == x.height) {
                            ...
                            "height"in x && (b = x.height,
                            f.parent().css("height", b),
                            f.css("height", b));
                        if ("scrollTo"in x)
                            v = parseInt(_.scrollTo);
                        else if ("scrollBy"in x)
                            v += parseInt(_.scrollBy);
                    ...
                    v = w("<div></div>").addClass(_.wrapperClass).css({
                        position: "relative",
                        overflow: "hidden",
                        width: _.width,
                        height: _.height
                    ...
                    f.parent().append(m),
                    f.parent().append(y),
                    _.railDraggable && m.bind("mousedown", function(e) {
                        var i = w(document);
                        return l = !0,
                    ...
                    f.bind("touchmove", function(t) {
                        ...
                        t.originalEvent.touches.length && (s((c - t.originalEvent.touches[0].pageY) / _.touchScrollStep, !0),
                        c = t.originalEvent.touches[0].pageY)
                    }),
                    i(),
                    "bottom" === _.start ? (m.css({
                        top: f.outerHeight() - m.outerHeight()
                    }),
                    s(0, !0)) : "top" !== _.start && (s(w(_.start).position().top, null, !0),
...
function(a) {
    ...
    var n = function(t, e) {
        this.$element = a(t),
        this.options = a.extend({}, n.defaults, e)
    };
    n.defaults = {
        ...
        if (isNaN(p))
            ...
            setTimeout(function() {
                ...
                var n = setInterval(function() {
                    ...
                    v(r),
                    clearInterval(n)),
                    "none" !== c.display_text && (a = c.use_percentage ? c.percent_format(t) : c.amount_format(e, d, u),
                    "fill" === c.display_text ? r.text(a) : "center" === c.display_text && (l.text(a),
                    h.text(a))),
...
function(k, B, N) {
    ...
    t = function(z) {
        ...
        e = function() {
            ...
            ,
            1 < arguments.length ? (arguments[0] ? (t.prototype = z.extend(new arguments[0], arguments[arguments.length - 1]),
            ...
            z.extend.apply(z, e))) : t.prototype = arguments[0],
            t.prototype.cls = t
        }
        ,
        z.SPFormatClass = m = e({
            ...
            render: function(t, e, i) {
                ...
                return this.format.replace(this.fre, function() {
                    ...
                    n = arguments[3],
                    (s = l.precre.exec(a)) ? (o = s[2],
                    a = s[1]) : o = !1,
                    (r = h[a]) === N ? "" : n && e && e[n] ? e[n].get ? e[n].get(r) || r : e[n][r] || r : (c(r) && (r = i.get("numberFormatter") ? i.get("numberFormatter")(r) : p(r, o, i.get("numberDigitGroupCount"), i.get("numberDigitGroupSep"), i.get("numberDecimalMark"))),
                    r)
                })
            }
        }),
        ...
        x = function(t, e) {
            var i;
            return 2 === e ? (i = B.floor(t.length / 2),
            t.length % 2 ? t[i] : (t[i - 1] + t[i]) / 2) : t.length % 2 ? (i = (t.length * e + e) / 4) % 1 ? (t[B.floor(i)] + t[B.floor(i) - 1]) / 2 : t[i - 1] : (i = (t.length * e + 2) / 4) % 1 ? (t[B.floor(i)] + t[B.floor(i) - 1]) / 2 : t[i - 1]
        }
        ,
        F = function(t) {
            var e;
        ...
        p = function(t, e, i, s, a) {
            ...
            (n = (n = z.inArray(".", t)) < 0 ? t.length : n) < t.length && (t[n] = a),
            r = n - i; 0 < r; r -= i)
                t.splice(r, 0, s);
            return t.join("")
        }
        ...
        z.fn.simpledraw = function(t, e, i, s) {
            var a, n;
            if (i && (a = this.data("_jqs_vcanvas")))
                return a;
            if (!1 === z.fn.sparkline.canvas)
                return !1;
            ...
            return t === N && (t = z(this).innerWidth()),
        ...
        u = e({
            ...
            updateDisplay: function() {
                var t, e, i, s, a = this.splist, n = a.length, r = !1, o = this.$canvas.offset(), l = this.currentPageX - o.left, h = this.currentPageY - o.top;
                if (this.over) {
                    for (e = 0; e < n; e++)
                        (i = a[e].setRegionHighlight(this.currentEl, l, h)) && (r = !0);
                    if (r) {
                        if ((s = z.Event("sparklineRegionChange")).sparklines = this.splist,
                        this.$el.trigger(s),
                        this.tooltip) {
                            for (t = "",
                            e = 0; e < n; e++)
        ...
        z.fn.sparkline = function(h, i) {
            return this.each(function() {
                ...
                if (t = function() {
                    var t, e, i, s, a, n, r;
                    "html" === h || h === N ? ((r = this.getAttribute(o.get("tagValuesAttribute"))) !== N && null !== r || (r = l.html()),
                    t = r.replace(/(^\s*<!--)|(-->\s*$)|\s+/g, "").split(",")) : t = h,
                    e = "auto" === o.get("width") ? t.length * o.get("defaultPixelsPerValue") : o.get("width"),
                    "auto" === o.get("height") ? o.get("composite") && z.data(this, "_jqs_vcanvas") || ((s = k.createElement("span")).innerHTML = "a",
                    l.html(s),
                    i = z(s).innerHeight() || z(s).height(),
                    z(s).remove(),
                    s = null) : i = o.get("height"),
                    o.get("disableInteraction") ? a = !1 : (a = z.data(this, "_jqs_mhandler")) ? o.get("composite") || a.reset() : (a = new u(this,o),
                    z.data(this, "_jqs_mhandler", a)),
                    !o.get("composite") || z.data(this, "_jqs_vcanvas") ? ((n = new (z.fn.sparkline[o.get("type")])(this,t,o,e,i)).render(),
                    a && a.registerSparkline(n)) : z.data(this, "_jqs_errnotify") || (alert("Attempted to attach a composite sparkline to an element with no existing sparkline"),
        ...
        z.sparkline_display_visible = function() {
            ...
            i = y.length; e < i; e++)
                t = y[e][0],
                z(t).is(":visible") && !z(t).parents().is(":hidden") ? (y[e][1].call(t),
                z.data(y[e][0], "_jqs_pending", !1),
                s.push(e)) : z(t).closest("html").length || z.data(t, "_jqs_pending") || (z.data(y[e][0], "_jqs_pending", !1),
                s.push(e));
            for (e = s.length; e; e--)
                y.splice(s[e - 1], 1)
        }
            ...
            getTagSetting: function(t) {
                ...
                if (this.tagValCache.hasOwnProperty(t))
                    ...
                    if ((e = this.tag.getAttribute(n + t)) === N || null === e)
                        ...
                        e = {},
                        i = s.length; i--; )
                            e[(a = s[i].split(":", 2))[0].replace(/(^\s*)|(\s*$)/g, "")] = F(a[1].replace(/(^\s*)|(\s*$)/g, ""));
                    else
                        e = F(e);
        ...
        z.fn.sparkline._base = e({
            ...
            setRegionHighlight: function(t, e, i) {
                ...
                return e > this.canvasWidth || i > this.canvasHeight || e < 0 || i < 0 ? null : a !== (s = this.getRegion(t, e, i)) && (a !== N && n && this.removeHighlight(),
                (this.currentRegion = s) !== N && n && this.renderHighlight(),
                !0)
            },
            clearRegionHighlight: function() {
                return this.currentRegion !== N && (this.removeHighlight(),
                !(this.currentRegion = N))
            },
            ...
            getCurrentRegionTooltip: function() {
                ...
                r && o) {
                    ...
                    n = t.length; n--; )
                        h = t[n][o],
                        -1 != (d = z.inArray(h, r)) && (l[d] = t[n]);
                    t = l
                }
                for (i = e.length,
                u = t.length,
                n = 0; n < i; n++)
                    for ("string" == typeof (p = e[n]) && (p = new m(p)),
                    s = p.fclass || "jqsfield",
                    d = 0; d < u; d++)
                        t[d].isNull && g.get("tooltipSkipNull") || (z.extend(t[d], {
        ...
        a = {
            changeHighlight: function(t) {
                ...
                a && (e = this.renderRegion(i, t),
                z.isArray(e) || z.isArray(a) ? (s.replaceWithShapes(a, e),
                this.regionShapes[i] = z.map(e, function(t) {
                    return t.id
                })) : (s.replaceWithShape(a, e),
        ...
        z.fn.sparkline.line = A = e(z.fn.sparkline._base, {
            ...
            renderHighlight: function() {
                var t, e, i = this.currentRegion, s = this.target, a = this.vertices[i], n = this.options, r = n.get("spotRadius"), o = n.get("highlightSpotColor"), l = n.get("highlightLineColor");
                a && (r && o && (t = s.drawCircle(a[0], a[1], r, N, o),
                this.highlightSpotId = t.id,
                s.insertAfterShape(this.lastShapeId, t)),
                l && (e = s.drawLine(a[0], this.canvasTop, a[0], this.canvasTop + this.canvasHeight, l),
            ...
            scanValues: function() {
                ...
                for (t = 0; t < r; t++)
                    ...
                    a = i && n[t].split(":"),
                    i && 2 === a.length ? (o.push(Number(a[0])),
                    l.push(Number(a[1])),
                    h.push(Number(a[1]))) : s ? (o.push(e[0]),
                    l.push(e[1]),
                    h.push(e[1])) : (o.push(t),
                    null === n[t] || "null" === n[t] ? l.push(null) : (l.push(Number(e)),
                    h.push(Number(e))));
            ...
            render: function() {
                var t, e, i, s, a, n, r, o, l, h, c, p, u, d, g, f, v, m, y, b, x, _, w, C, k = this.options, S = this.target, R = this.canvasWidth, M = this.canvasHeight, T = this.vertices, I = k.get("spotRadius"), H = this.regionMap;
                if (A._super.render.call(this) && (this.scanValues(),
                ...
                this.yminmax.length && !(this.yvalues.length < 2))) {
                    ...
                    I && (R < 4 * I || M < 4 * I) && (I = 0),
                    I && (((b = k.get("highlightSpotColor") && !k.get("disableInteraction")) || k.get("minSpotColor") || k.get("spotColor") && w[i] === this.miny) && (M -= B.ceil(I)),
                    (b || k.get("maxSpotColor") || k.get("spotColor") && w[i] === this.maxy) && (M -= B.ceil(I),
                    s += B.ceil(I)),
                    (b || (k.get("minSpotColor") || k.get("maxSpotColor")) && (w[0] === this.miny || w[0] === this.maxy)) && (a += B.ceil(I),
                    R -= B.ceil(I)),
                    ...
                    C = 0; C < g; C++)
                        ...
                        H[C] = [u || 0, d, C],
                        u = d,
                        null === h ? C && (null !== w[C - 1] && (r = [],
                        o.push(r)),
                        T.push(null)) : (h < this.miny && (h = this.miny),
                    ...
                    m = o.length,
                    C = 0; C < m; C++)
                        (r = o[C]).length && (k.get("fillColor") && (r.push([r[r.length - 1][0], s + M]),
                        v.push(r.slice(0)),
                        r.pop()),
                    ...
                    for (m = v.length,
                    C = 0; C < m; C++)
                        S.drawShape(v[C], k.get("fillColor"), k.get("fillColor")).append();
                    for (k.get("normalRangeMin") !== N && k.get("drawNormalOnTop") && this.drawNormalRange(a, s, M, R, e),
                    m = f.length,
                    C = 0; C < m; C++)
                        S.drawShape(f[C], k.get("lineColor"), N, k.get("lineWidth")).append();
                    if (I && k.get("valueSpots"))
                        for ((y = k.get("valueSpots")).get === N && (y = new D(y)),
                        C = 0; C < g; C++)
                    ...
                    this.maxy !== this.minyorg && (I && k.get("minSpotColor") && (l = _[z.inArray(this.minyorg, w)],
                    S.drawCircle(a + B.round((l - this.minx) * (R / t)), s + B.round(M - M * ((this.minyorg - this.miny) / e)), I, N, k.get("minSpotColor")).append()),
                    I && k.get("maxSpotColor") && (l = _[z.inArray(this.maxyorg, w)],
                    S.drawCircle(a + B.round((l - this.minx) * (R / t)), s + B.round(M - M * ((this.maxyorg - this.miny) / e)), I, N, k.get("maxSpotColor")).append())),
        ...
        z.fn.sparkline.bar = O = e(z.fn.sparkline._base, a, {
            type: "bar",
            init: function(t, e, i, s, a) {
                var n, r, o, l, h, c, p, u, d, g, f, v, m, y, b, x, _, w, C, k, S, R = parseInt(i.get("barWidth"), 10), M = parseInt(i.get("barSpacing"), 10), T = i.get("chartRangeMin"), I = i.get("chartRangeMax"), H = i.get("chartRangeClip"), A = 1 / 0, P = -1 / 0;
                for (O._super.init.call(this, t, e, i, s, a),
                c = 0,
                p = e.length; c < p; c++)
                    ((n = "string" == typeof (k = e[c]) && -1 < k.indexOf(":")) || z.isArray(k)) && (b = !0,
                    n && (k = e[c] = W(k.split(":"))),
                    k = L(k, null),
                ...
                p = e.length; c < p; c++)
                    if (b)
                        ...
                        _ = 0,
                        w = x.length; _ < w; _++)
                            null !== (k = C[_] = H ? E(x[_], m, y) : x[_]) && (0 < k && (q[c] += k),
                            A < 0 && 0 < P ? k < 0 ? j[c] += B.abs(k) : l[c] += k : l[c] += B.abs(k - (k < 0 ? P : A)),
                            h.push(k));
                    else
                        k = H ? E(e[c], m, y) : e[c],
                ...
                f < g ? (S = ((b && 0 <= v ? P : v) - g) / u * this.canvasHeight) !== B.ceil(S) && (this.canvasHeightEf -= 2,
                S = B.ceil(S)) : S = this.canvasHeight,
                this.yoffset = S,
                z.isArray(i.get("colorMap")) ? (this.colorMapByIndex = i.get("colorMap"),
                this.colorMapByValue = null) : (this.colorMapByIndex = null,
                this.colorMapByValue = i.get("colorMap"),
                this.colorMapByValue && this.colorMapByValue.get === N && (this.colorMapByValue = new D(this.colorMapByValue))),
                this.range = u
            },
            getRegion: function(t, e, i) {
            ...
            renderRegion: function(t, e) {
                var i, s, a, n, r, o, l, h, c, p, u = this.values[t], d = this.options, g = this.xaxisOffset, f = [], v = this.range, m = this.stacked, y = this.target, b = t * this.totalBarWidth, x = this.canvasHeightEf, _ = this.yoffset;
                if (l = (u = z.isArray(u) ? u : [u]).length,
                h = u[0],
                n = w(null, u),
                p = w(g, u, !0),
                n)
                    return d.get("nullColor") ? (a = e ? d.get("nullColor") : this.calcHighlightColor(d.get("nullColor"), d),
                    i = 0 < _ ? _ - 1 : _,
                    y.drawRect(b, i, this.barWidth - 1, 0, a, a)) : N;
                for (r = _,
                o = 0; o < l; o++) {
                    if (h = u[o],
                    m && h === g) {
        ...
        z.fn.sparkline.tristate = o = e(z.fn.sparkline._base, a, {
            ...
            renderRegion: function(t, e) {
                ...
                l[t] < 0 ? s = (r = a) - 1 : 0 < l[t] ? (r = 0,
                s = a - 1) : (r = a - 1,
                s = 2),
                null !== (o = this.calcColor(l[t], t)))
                    return e && (o = this.calcHighlightColor(o, h)),
        ...
        z.fn.sparkline.discrete = r = e(z.fn.sparkline._base, a, {
            ...
            init: function(t, e, i, s, a) {
                ...
                this.initTarget(),
                this.target && (this.lineHeight = "auto" === i.get("lineHeight") ? B.round(.3 * this.canvasHeight) : i.get("lineHeight"))
            },
            getRegion: function(t, e, i) {
            ...
            renderRegion: function(t, e) {
                var i, s, a, n, r = this.values, o = this.options, l = this.min, h = this.max, c = this.range, p = this.interval, u = this.target, d = this.canvasHeight, g = this.lineHeight, f = d - g;
                return s = E(r[t], l, h),
                n = t * p,
                i = B.round(f - f * ((s - l) / c)),
        ...
        z.fn.sparkline.bullet = l = e(z.fn.sparkline._base, {
            ...
            renderRange: function(t, e) {
                ...
                return e && (a = this.calcHighlightColor(a, this.options)),
            ...
            renderPerformance: function(t) {
                ...
                this.target.drawRect(0, B.round(.3 * this.canvasHeight), i - 1, B.round(.4 * this.canvasHeight) - 1, s, s)
            },
            renderTarget: function(t) {
                ...
                return t && (n = this.calcHighlightColor(n, this.options)),
                this.target.drawRect(i, s, this.options.get("targetWidth") - 1, a - 1, n, n)
            },
            render: function() {
        ...
        z.fn.sparkline.pie = h = e(z.fn.sparkline._base, {
            ...
            init: function(t, e, i, s, a) {
                var n, r = 0;
                if (h._super.init.call(this, t, e, i, s, a),
                this.shapes = {},
                this.valueShapes = {},
                this.values = e = z.map(e, Number),
            ...
            renderSlice: function(t, e) {
                var i, s, a, n, r, o = this.target, l = this.options, h = this.radius, c = l.get("borderWidth"), p = l.get("offset"), u = 2 * B.PI, d = this.values, g = this.total, f = p ? 2 * B.PI * (p / 360) : 0;
                for (n = d.length,
                a = 0; a < n; a++) {
                    if (s = i = f,
                    0 < g && (s = f + u * (d[a] / g)),
                    t === a)
                        return r = l.get("sliceColors")[a % l.get("sliceColors").length],
            ...
            render: function() {
                ...
                if (h._super.render.call(this)) {
                    for (r && i.drawCircle(n, n, B.floor(n - r / 2), a.get("borderColor"), N, r).append(),
                    e = s.length; e--; )
        ...
        z.fn.sparkline.box = _ = e(z.fn.sparkline._base, {
            ...
            render: function() {
                var t, e, i, s, a, n, r, o, l, h, c, p = this.target, u = this.values, d = u.length, g = this.options, f = this.canvasWidth, v = this.canvasHeight, m = g.get("chartRangeMin") === N ? B.min.apply(B, u) : g.get("chartRangeMin"), y = g.get("chartRangeMax") === N ? B.max.apply(B, u) : g.get("chartRangeMax"), b = 0;
                if (_._super.render.call(this)) {
                    if (g.get("raw"))
                        g.get("showOutliers") && 5 < u.length ? (e = u[0],
                        t = u[1],
                        s = u[2],
                        a = u[3],
                        n = u[4],
                    ...
                    this.routlier = o,
                    c = f / (y - m + 1),
                    g.get("showOutliers") && (b = B.ceil(g.get("spotRadius")),
                    ...
                    p.drawRect(B.round((s - m) * c + b), B.round(.1 * v), B.round((n - s) * c), B.round(.8 * v), g.get("boxLineColor"), g.get("boxFillColor")).append(),
                    ...
                    p.drawLine(B.round((a - m) * c + b), B.round(.1 * v), B.round((a - m) * c + b), B.round(.9 * v), g.get("medianColor")).append(),
                    g.get("target") && (h = B.ceil(g.get("spotRadius")),
        ...
        v = e(g, {
            ...
            _drawShape: function(t, e, i, s, a) {
                ...
                h = e.length; c < h; c++)
                    p[c] = e[c][0] + "," + e[c][1];
                return n = p.splice(0, 1),
                a = a === N ? 1 : a,
                r = i === N ? ' stroked="false" ' : ' strokeWeight="' + a + 'px" strokeColor="' + i + '" ',
                o = s === N ? ' filled="false"' : ' fillColor="' + s + '" filled="true" ',
                l = p[0] === p[p.length - 1] ? "x " : "",
                '<v:shape coordorigin="0 0" coordsize="' + this.pixelWidth + " " + this.pixelHeight + '"  id="jqsshape' + t + '" ' + r + o + ' style="position:absolute;left:0px;top:0px;height:' + this.pixelHeight + "px;width:" + this.pixelWidth + 'px;padding:0px;margin:0px;"  path="m ' + n + " l " + p.join(", ") + " " + l + 'e"> </v:shape>'
            },
            _drawCircle: function(t, e, i, s, a, n, r) {
            ...
            _drawPieSlice: function(t, e, i, s, a, n, r, o) {
                ...
                return h === p && c === u && n - a < B.PI ? "" : (l = [e - s, i - s, e + s, i + s, h, c, p, u],
                d = r === N ? ' stroked="false" ' : ' strokeWeight="1px" strokeColor="' + r + '" ',
                g = o === N ? ' filled="false"' : ' fillColor="' + o + '" filled="true" ',
                '<v:shape coordorigin="0 0" coordsize="' + this.pixelWidth + " " + this.pixelHeight + '"  id="jqsshape' + t + '" ' + d + g + ' style="position:absolute;left:0px;top:0px;height:' + this.pixelHeight + "px;width:" + this.pixelWidth + 'px;padding:0px;margin:0px;"  path="m ' + e + "," + i + " wa " + l.join(", ") + ' x e"> </v:shape>')
            },
            _drawRect: function(t, e, i, s, a, n, r) {
...
var pJS = function(t, e) {
    ...
    d.fn.retinaInit = function() {
        d.retina_detect && 1 < window.devicePixelRatio ? (d.canvas.pxratio = window.devicePixelRatio,
    ...
    d.fn.particle = function(t, e, i) {
        ...
        d.particles.move.straight ? (this.vx = a.x,
        this.vy = a.y,
        ...
        if ("image" == this.shape) {
            ...
            "svg" == d.tmp.img_type && null != d.tmp.source_svg && (d.fn.vendors.createSvgImg(this),
    ...
    d.fn.particle.prototype.draw = function() {
        ...
        if (null != t.opacity_bubble)
            ...
            i = t.opacity;
        if (t.color.rgb)
            var s = "rgba(" + t.color.rgb.r + "," + t.color.rgb.g + "," + t.color.rgb.b + "," + i + ")";
        else
            s = "hsla(" + t.color.hsl.h + "," + t.color.hsl.s + "%," + t.color.hsl.l + "%," + i + ")";
        switch (d.canvas.ctx.fillStyle = s,
        ...
        0 < d.particles.shape.stroke.width && (d.canvas.ctx.strokeStyle = d.particles.shape.stroke.color,
    ...
    d.fn.particlesUpdate = function() {
        for (var t = 0; t < d.particles.array.length; t++) {
            ...
            if (d.particles.opacity.anim.enable && (1 == e.opacity_status ? (e.opacity >= d.particles.opacity.value && (e.opacity_status = !1),
            e.opacity += e.vo) : (e.opacity <= d.particles.opacity.anim.opacity_min && (e.opacity_status = !0),
            e.opacity -= e.vo),
            e.opacity < 0 && (e.opacity = 0)),
            d.particles.size.anim.enable && (1 == e.size_status ? (e.radius >= d.particles.size.value && (e.size_status = !1),
            e.radius += e.vs) : (e.radius <= d.particles.size.anim.size_min && (e.size_status = !0),
            e.radius -= e.vs),
            ...
            switch (e.x - e.radius > d.canvas.w ? (e.x = s.x_left,
            e.y = Math.random() * d.canvas.h) : e.x + e.radius < 0 && (e.x = s.x_right,
            e.y = Math.random() * d.canvas.h),
            e.y - e.radius > d.canvas.h ? (e.y = s.y_top,
            e.x = Math.random() * d.canvas.w) : e.y + e.radius < 0 && (e.y = s.y_bottom,
            e.x = Math.random() * d.canvas.w),
            d.particles.move.out_mode) {
            case "bounce":
                e.x + e.radius > d.canvas.w ? e.vx = -e.vx : e.x - e.radius < 0 && (e.vx = -e.vx),
                e.y + e.radius > d.canvas.h ? e.vy = -e.vy : e.y - e.radius < 0 && (e.vy = -e.vy)
            }
            if (isInArray("grab", d.interactivity.events.onhover.mode) && d.fn.modes.grabParticle(e),
            ...
            d.particles.line_linked.enable || d.particles.move.attract.enable)
                for (var a = t + 1; a < d.particles.array.length; a++) {
                    ...
                    d.particles.move.attract.enable && d.fn.interact.attractParticles(e, n),
    ...
    d.fn.interact.bounceParticles = function(t, e) {
        var i = t.x - e.x
          , s = t.y - e.y;
        Math.sqrt(i * i + s * s) <= t.radius + e.radius && (t.vx = -t.vx,
        t.vy = -t.vy,
        e.vx = -e.vx,
        e.vy = -e.vy)
    }
    ...
    d.fn.modes.pushParticles = function(t, e) {
        ...
        for (var i = 0; i < t; i++)
            ...
            i == t - 1 && (d.particles.move.enable || d.fn.particlesDraw(),
            d.tmp.pushing = !1)
    }
    ,
    ...
    d.fn.modes.bubbleParticle = function(o) {
        function t() {
            o.opacity_bubble = o.opacity,
            o.radius_bubble = o.radius
        }
        function e(t, e, i, s, a) {
            if (t != e)
                if (d.tmp.bubble_duration_end) {
                    if (null != i)
                        r = t + (t - (s - c * (s - t) / d.interactivity.modes.bubble.duration)),
        ...
        if (d.interactivity.events.onhover.enable && isInArray("bubble", d.interactivity.events.onhover.mode)) {
            ...
            if (d.tmp.bubble_clicking) {
                ...
                c > d.interactivity.modes.bubble.duration && (d.tmp.bubble_duration_end = !0),
                c > 2 * d.interactivity.modes.bubble.duration && (d.tmp.bubble_clicking = !1,
                d.tmp.bubble_duration_end = !1)
            }
            d.tmp.bubble_clicking && (e(d.interactivity.modes.bubble.size, d.particles.size.value, o.radius_bubble, o.radius, "size"),
            e(d.interactivity.modes.bubble.opacity, d.particles.opacity.value, o.opacity_bubble, o.opacity, "opacity"))
        }
    }
    ,
    d.fn.modes.repulseParticle = function(s) {
        if (d.interactivity.events.onhover.enable && isInArray("repulse", d.interactivity.events.onhover.mode) && "mousemove" == d.interactivity.status) {
            ...
            "bounce" == d.particles.move.out_mode ? (0 < o.x - s.radius && o.x + s.radius < d.canvas.w && (s.x = o.x),
            0 < o.y - s.radius && o.y + s.radius < d.canvas.h && (s.y = o.y)) : (s.x = o.x,
            s.y = o.y)
            ...
            d.tmp.repulse_clicking) {
                ...
                p <= l && function() {
                    ...
                    if (s.vx = u * Math.cos(t),
                    s.vy = u * Math.sin(t),
                    "bounce" == d.particles.move.out_mode) {
                        var e = s.x + s.vx
                          , i = s.y + s.vy;
                        e + s.radius > d.canvas.w ? s.vx = -s.vx : e - s.radius < 0 && (s.vx = -s.vx),
                        i + s.radius > d.canvas.h ? s.vy = -s.vy : i - s.radius < 0 && (s.vy = -s.vy)
                    }
                }()
            } else
                0 == d.tmp.repulse_clicking && (s.vx = s.vx_i,
                s.vy = s.vy_i)
    }
    ,
    ...
    d.fn.vendors.eventsListeners = function() {
        ...
        (d.interactivity.events.onhover.enable || d.interactivity.events.onclick.enable) && (d.interactivity.el.addEventListener("mousemove", function(t) {
    ...
    d.fn.vendors.checkOverlap = function(t, e) {
        for (var i = 0; i < d.particles.array.length; i++) {
            var s = d.particles.array[i]
              , a = t.x - s.x
              , n = t.y - s.y;
            Math.sqrt(a * a + n * n) <= t.radius + s.radius && (t.x = e ? e.x : Math.random() * d.canvas.w,
    ...
    d.fn.vendors.createSvgImg = function(n) {
        var t = d.tmp.source_svg.replace(/#([0-9A-F]{3,6})/gi, function(t, e, i, s) {
            if (n.color.rgb)
                var a = "rgba(" + n.color.rgb.r + "," + n.color.rgb.g + "," + n.color.rgb.b + "," + n.opacity + ")";
            else
                a = "hsla(" + n.color.hsl.h + "," + n.color.hsl.s + "%," + n.color.hsl.l + "%," + n.opacity + ")";
            return a
        })
          , e = new Blob([t],{
        ...
        "" != d.particles.shape.image.src)
            if ("svg" == t) {
                ...
                e.onreadystatechange = function(t) {
                    4 == e.readyState && (200 == e.status ? (d.tmp.source_svg = t.currentTarget.response,
    ...
    d.fn.vendors.draw = function() {
        ...
        d.particles.move.enable ? d.fn.drawAnimFrame = requestAnimFrame(d.fn.vendors.draw) : cancelRequestAnimFrame(d.fn.drawAnimFrame)) : d.tmp.img_error || (d.fn.drawAnimFrame = requestAnimFrame(d.fn.vendors.draw)) : null != d.tmp.img_obj ? (d.fn.particlesDraw(),
    ...
    d.fn.vendors.checkBeforeDraw = function() {
        "image" == d.particles.shape.type ? "svg" == d.tmp.img_type && null == d.tmp.source_svg ? d.tmp.checkAnimFrame = requestAnimFrame(check) : (cancelRequestAnimFrame(d.tmp.checkAnimFrame),
